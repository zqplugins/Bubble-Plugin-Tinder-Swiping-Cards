...
function(instance, properties, context) {
    ...
    //s.style["max-height"] = document.body.clientHeight + "px";
    s.style["max-width"] = document.body.clientWidth + "px";
    s.id = "cardsDeck"+instanceID;
    //s.style.minHeight = "undefined";
    ...
    */
    ...
    //console.log("cards",properties.cards.get(0,1000))
