function(instance, properties) {
    ...
    *, *:before, *:after {
    ...
    //let arrImages = properties.images.split(",")
    ...
    $( document ).ready(function() {
		...
		var titlesHTML = document.querySelectorAll(".tinder--card > h3")
        ...
        var bodiesHTML = document.querySelectorAll(".tinder--card > p")
        ...
        var imagesHTML = document.querySelectorAll(".tinder--card > img")
